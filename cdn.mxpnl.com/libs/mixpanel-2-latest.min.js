(function() {
    ...
    (function() {
        function Aa() {
            function a() {
                if (!a.Dc) la = a.Dc = m, ma = D, c.a(F, function(a) {
                    a.qc()
                })
            }
            ...
            if (t.addEventListener) "complete" === t.readyState ? a() : t.addEventListener("DOMContentLoaded", a, D);
        ...
        function q(a) {
            ...
            var b = a.persistence;
            if ("cookie" !== b && "localStorage" !== b) o.A("Unknown persistence type " + b + "; falling back to cookie"), b = a.persistence = "cookie";
            this.j = "localStorage" ===
                b && c.localStorage.sa() ? c.localStorage : c.cookie;
            this.load();
            this.kc(a);
            this.wd();
            this.save()
        ...
        function sa(a, b, d) {
            !c.Wa(b) || !b.length ? o.error("gdpr." + (a ? "optIn" : "optOut") + " called with an invalid token") : (d = d || {}, V(d).set(W(b, d), a ? 1 : 0, c.Jb(d.wb) ? d.wb : r, !!d.xb, !!d.Yc, !!d.Ac, d.vb), d.o && a && d.o(d.pd || "$opt_in", d.qd, {
                send_immediately: m
            }))
        }
        ...
        c.bind = function(a, b) {
            ...
            return f = function() {
                ...
                c.prototype = r;
                c =
                    a.apply(g, d.concat(L.call(arguments)));
        ...
        c.O = function(a) {
            return !a ? [] : a.O ? a.O() : c.isArray(a) || c.Lc(a) ? L.call(a) : c.yd(a)
        };
                ...
                function b(a, c) {
                    ...
                    switch (typeof s) {
                        ...
                        case "object":
                            ...
                            for (v in s) X.call(s, v) && (i = b(v, s)) && p.push(d(v) + (g ? ": " : ":") + i);
                        ...
                        a: {
                            ...
                            if ("{" === i) {
                                ...
                                for (; i;) {
                                    ...
                                    b();
                                    h(":");
                                    Object.hasOwnProperty.call(k, v) && g('Duplicate key "' + v + '"');
                                    k[v] = s();
                                    b();
                                    if ("}" === i) {
                                        h("}");
        ...
        c.xd = function(a) {
            ...
            for (g = 0; g < h; g++) {
                ...
                i !== r && (f > c && (b += a.substring(c, f)), b += i, c = f = g + 1)
            }
        ...
        c.ib = function() {
            ...
            function b() {
                var a = 1 * new Date,
                    b;
                if (n.performance &&
                    n.performance.now) b = n.performance.now();
                else
        ...
        c.cookie = {
            get: function(a) {
                for (var a = a + "=", b = t.cookie.split(";"), c = 0; c < b.length; c++) {
                    for (var f = b[c];
            ...
            Dd: function(a, b, c, f, h, g, e) {
                var i = "",
                    k = "",
                    p = "";
                e ? i = "; domain=" + e : f && (i = (i = ra(t.location.hostname)) ? "; domain=." + i : "");
        ...
        c.Cc = function() {
            ...
            function b(b) {
                ...
                for (i = 0; i < b.length; i++)
                    ...
                    w = [];
                    for (k = d = 0; k < g.length; k++) g[k].className && c.Wa(g[k].className) && a(g[k], B) && (w[d++] = g[k])
        ...
        qa.prototype.hb = function(a, b, c) {
            function f() {
                ...
                try {
                    ...
                    j.removeItem(o), j.getItem(q) === k && j.removeItem(q), j.getItem(n) === k && j.removeItem(n)
                }
            }
            ...
            function i(a) {
                (new Date).getTime() - p > B ? (Qa.error("Timeout waiting for mutex on " + s + "; clearing lock. [" + k + "]"), j.removeItem(o), j.removeItem(q), h()) : setTimeout(function() {
                    try {
                        a()
                    } catch (c) {
                        b && b(c)
            ...
            if (b.length < a) {
                ...
                if (d.length) {
                    ...
                    for (var h = 0; h < d.length; h++) {
                        var g = d[h];
                        if ((new Date).getTime() > g.flushAfter && !f[g.id] && (g.Rc = m, b.push(g), b.length >= a)) break
                    }
                }
            }
            return b
        ...
        G.prototype.da = function() {
            var a;
            try {
                if (a = this.j.getItem(this.N)) a = aa(a), c.isArray(a) || (this.h("Invalid storage entry:", a), a = r)
            } catch (b) {
                    ...
                    c.a(h, function(a) {
                        ...
                        if (b) {
                            ...
                            var d = m,
                                f = a.id;
                            if (f) {
                                if (5 < (this.G[f] || 0)) this.h("[dupe] item ID sent too many times, not sending", {
                                    item: a,
                                    D: h.length,
                                    od: this.G[f]
                                }), d = D
                    ...
                    if (1 >
                        ...
                        var i = c.bind(function(e) {
                                ...
                                try {
                                    ...
                                    if (a.ic) this.ba.vd(v);
                                    ...
                                    else if (c.e(e) && e.R && (500 <= e.R.status || 429 === e.R.status || "timeout" === e.error)) {
                                        var i = 2 * this.pa,
                                        ...
                                        if (1 < h.length) {
                                            ...
                                            this.ea()
                                        } else this.h("Single-event request too large; dropping", h), this.Wb(), g = m;
                                    else g = m;
                                    g && (this.ba.Tc(c.map(h, function(a) {
                                        return a.id
                                    }), c.bind(function(a) {
                                        a ? (this.Ja = 0, this.flush()) : (this.h("Failed to remove items from queue"), 5 < ++this.Ja ? (this.h("Too many queue failures; disabling batching system."), this.jd()) : this.ea())
                                    }, this)), c.a(h, c.bind(function(a) {
                                        var b = a.id;
                                        b ? (this.G[b] =
                                            this.G[b] || 0, this.G[b]++, 5 < this.G[b] && this.h("[dupe] item ID sent too many times", {
                                                item: a,
                                                D: h.length,
                                                od: this.G[b]
        ...
        j.prototype.k = function(a, b) {
            ...
            d = c.Ma(a);
            return !this.Da() ? (this.rc(a), c.g(b) || (this.p("verbose") ? b({
                status: -1,
                error: r
        ...
        j.prototype.V = function(a, b, d, f) {
            var e = this,
                ...
                j = g;
            !c.g(g) && c.e(g) && !c.ra(g) && (e.d.persistence.v(a, g), e.d.persistence.save(), f && (j = f(g)), b.call(e, j, function(b, f) {
        ...
        j.prototype.sc = function(a, b, d, f, e, g, j) {
            ...
            if (!c.g(a) && c.isArray(a) && a.length)
                for (var k, b = function(a, b) {
                        ...
                        c.g(d) || d(a, b)
                    }, f = a.length - 1; 0 <= f; f--) a = this.d.persistence.$("$append"), k = a.pop(), i.d.persistence.save(), c.ra(k) || i.append(k, b);
            a = this.d.persistence.$("$remove");
            if (!c.g(a) && c.isArray(a) && a.length)
                for (var p, b = function(a, b) {
                        0 === a && i.d.persistence.q("$remove", p);
                        c.g(j) || j(a, b)
                    }, f = a.length - 1; 0 <= f; f--) a = this.d.persistence.$("$remove"), p = a.pop(), i.d.persistence.save(), c.ra(p) || i.remove(p, b)
        };
        ...
        q.prototype.save = function() {
            this.disabled || this.j.set(this.name, c.ha(this.props), this.Pa, this.Ka, this.Yb, this.yb, this.na)
        };
        ...
        q.prototype.w = function(a, b, d) {
            return c.e(a) ? ("undefined" === typeof b && (b = "None"), this.Pa = "undefined" === typeof d ? this.zb : d, this.load(), c.a(a, function(a, c) {
        ...
        q.prototype.q = function(a, b) {
            ...
            }), this.v("$unset", f)) : "__mpr" === d ? (p.push(f), this.v("$append", f)) : "__mpap" === d && (n.push(f), this.v("$unset", f));
        ...
        e.prototype.X = function(a, b, d) {
            ...
            this.config = {};
            var f = {};
            "api_payload_format" in b || (b.api_host || za.api_host).match(/\.mixpanel\.com/) && (f.api_payload_format = "json");
            this.$b(c.extend({}, za, f, b, {
                name: d,
                token: a,
            ...
            if (this.T = this.c("batch_requests"))
                if (!c.localStorage.sa(m) || !O) this.T = D, o.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"),
            ...
            (a = this.c("track_pageview")) &&
            this.uc(a);
            0 < this.c("record_sessions_percent") && 100 * Math.random() <= this.c("record_sessions_percent") && this.dc()
        };
        ...
        e.prototype.ld = function() {
            this.I ? this.I.stopRecording() : o.A("Session recorder module not loaded")
        };
        ...
        e.prototype.uc = function(a) {
            ...
            if (c.Ta(["full-url", "url-with-path-and-query-string", "url-with-path"], a)) {
                ...
                if ("function" === typeof f) n.history.replaceState = function(a,
                    b, c) {
        ...
        e.prototype.k = function(a, b, d, f) {
            ...
            var a = a + ("?" + c.nc(b)),
                p = this;
            if ("img" in b) j = t.createElement("img"), j.src = a, t.body.appendChild(j);
            else if (i) {
                try {
                    e = ba(a, j)
                } catch (n) {
                ...
                o.onreadystatechange = function() {
                    if (4 === o.readyState)
                        ...
                        } else a = o.timeout && !o.status && (new Date).getTime() - x >= o.timeout ? "timeout" : "Bad HTTP status: " + o.status + " " + o.statusText, p.l(a), f && (k ? f({
                            status: 0,
                            error: a,
                            R: o
                        }) : f(0))
                ...
                p.l(y),
                    e = D
            } else j = t.createElement("script"), j.type = "text/javascript", j.async = m, j.defer = m, j.src = a, u = t.getElementsByTagName("script")[0], u.parentNode.insertBefore(j, u);
            return e
        };
        ...
        e.prototype.ab = function() {
            this.oc = m;
            if (this.rb()) this.T = m, c.a(this.u, function(a) {
                a.start()
            })
        };
        ...
        e.prototype.disable = function(a) {
            "undefined" === typeof a ? this.U.Bc = m : this.xa = this.xa.concat(a)
        };
        ...
        e.prototype.Fa = function(a, b) {
            var d = c.truncate(a.data, 255),
                ...
                k = c.bind(function() {
                    ...
                    return d ? (o.log("MIXPANEL REQUEST:"), o.log(d), this.k(e, this.lb(d), j, this.nb(b, d))) : r
                }, this);
            this.T && !g ? h.Na(d, function(a) {
                    a ? b(1, d) : k()
                }) : i =
                k();
            return i && d
        ...
        e.prototype.o = K(function(a, b, d, e) {
            ...
            if (c.g(a)) this.l("No event name provided to mixpanel.track");
                ...
                b = c.extend({}, c.info.aa({
                        mp_loader: this.c("mp_loader")
                    }),
                    g, this.persistence.aa(), this.P, this.Db(), b);
        ...
        e.prototype.Hc = function(a, b) {
            var c = this.pc(a, b),
                e = this.kb[c];
            if (e === l || e.Ca !== a || e.Ba !== b) e = new u, e.X(this, a, b), this.kb[c] = e;
            return e
        };
        ...
        e.prototype.nd = function(a) {
            c.g(a) ? this.l("No event name provided to mixpanel.time_event") : this.mb(a) || this.persistence.ed(a)
        };
        var Da = {
            persistent: m
        };
        ...
        e.prototype.Sa = function(a, b, c,
            ...
            a !== k && a !== this.s("__alias") && (this.Q("__alias"), this.m({
                distinct_id: a
            }));
            this.U.Eb = m;
        ...
        e.prototype.wc = function(a, b) {
            ...
            var d = this;
            c.g(b) && (b = this.L());
            if (a !== b) return this.ob("__alias", a), this.o("$create_alias", {
                alias: a,
                distinct_id: b
            }, {
                cc: m
        ...
        e.prototype.$b = function(a) {
            if (c.e(a)) c.extend(this.config, a), a.batch_size && c.a(this.u, function(a) {
                a.Wb()
            }), this.c("persistence_name") || (this.config.persistence_name = this.config.cookie_name), this.c("disable_persistence") || (this.config.disable_persistence = this.config.disable_cookie), this.persistence && this.persistence.kc(this.config), J = J || this.c("debug")
        };
        ...
        e.prototype.tc = function() {
            "localStorage" === this.c("opt_out_tracking_persistence_type") && c.localStorage.sa() && (!this.qa() && this.qa({
            ...
            else if (!this.qa() && (this.c("opt_out_tracking_by_default") || c.cookie.get("mp_optout"))) c.cookie.remove("mp_optout"), this.Ya({
        ...
        e.prototype.ia = function(a) {
            ...
            !this.c("disable_persistence") &&
                this.persistence.disabled !== a && this.persistence.ac(a);
        ...
        e.prototype.Ya = function(a) {
            ...
            a.delete_user && this.people && this.people.Da() &&
