            ...
            showPopup && ( <
                ...
                div className = "popup-content" > {
                    submitted ? ( <
                        ...
                        <
                        img src = "https://res.cloudinary.com/dapbrn8a9/image/upload/q_auto:low/v1707226119/thanku_hfiump.jpg"
                        className = 'thankuavtar'
                        alt = "tankUBox" / >
                        <
                        /div>

                        <
                        div class = "h-3" > Thank you
                        for subscribing! < /div> <
                        ...
                        ( <
                            ...
                            <
                            img src = "https://res.cloudinary.com/dapbrn8a9/image/upload/q_auto:low/v1706783129/Frokerassets/Group_1171276820_1_hysw5m.jpg"
                            className = 'pic'
                            ...
                            for Exclusive Updates, Tips, and More. <
                            /div> <
