...
export default function Blog() {
    ...
    return (
        currentBlog && ( <
            ...
            <
            div className = "by-joanna-wellick" > {
            ...
            {
                isLiked ? ( <
                    img src = "https://res.cloudinary.com/dapbrn8a9/image/upload/q_auto:low/v1706522062/Frokerassets/Page-1_igjnhi.jpg"
                    className = "likeimg"
                    alt = "liked icon" /
                    >
                ) : ( <
                    img src = "https://res.cloudinary.com/dapbrn8a9/image/upload/q_auto:low/v1707285106/Frokerassets/Artboard_ne0yo2.jpg"
                    className = "likeimg"
                    alt = "unliked icon" /
                    >
                )
            ...
            dangerouslySetInnerHTML = {
                {
                    __html: currentBlog ? .parafour
                }
            } > < /div> <
            div className = "para4"
            dangerouslySetInnerHTML = {
                {
                    __html: currentBlog ? .parafive
                }
            } > < /div> <
            div className = "para4"
            dangerouslySetInnerHTML = {
                {
                    __html: currentBlog ? .conclusion
                }
            } > < /div> <
            /div> <
            div className = "body2" >
