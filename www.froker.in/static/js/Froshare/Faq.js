...
function Faq() {
    ...
    return ( <
        div className = 'w-full h-full flex flex-col justify-center items-center pt-10 relative' >
        <
        div className = 'flex flex-col-reverse md:flex-row justify-center items-center w-full md:w-[80%] xl:w-[40%]' >

        <
        div className = 'text-[#F76F32] font-Gilroy font-bold text-3xl flex justify-center items-center md:mt-10 md:mb-10 text-center' > Frequently Asked Questions < /div>

        <
        div className = 'w-[40%] md:w-[30%] flex justify-center items-center' >
        <
        img src = {
            'https://res.cloudinary.com/dapbrn8a9/image/upload/v1711203696/Untitled_design_-_2024-03-20T121153_1_xussyt.png'
        }
        alt = 'img of faqs' / >
        <
        /div>
...

        {
            faqData.map((faq, index) => ( <
                ...
                className = {
                    `cursor-pointer faq-container w-[90%] md:w-[55%] ${activeIndex === index ? 'active' : ''}`
                }
                onClick = {
                    () => toggleFaq(index)
                } >
                ...
                className = {
                    `faq ${activeIndex === index ? 'active' : ''}`
                } >
                <
                h3 className = 'faq-title font-medium font-Gilroy text-lg ' > {
                    faq.question
                } < /h3> <
                p className = 'faq-text font-normal font-Gilroy2 text-lg' > {
                    faq.answer
                } < /p> <
                ...
                <
                FaAngleRight color = {
                    `${activeIndex === index ? '#ffffff' : '#F76F32'}`
                }
                className = {
                    ` dark:text-[#F76F32]${
        ...
        <
        img src = {
            'https://res.cloudinary.com/dapbrn8a9/image/upload/v1711627656/Untitled_design_-_2024-03-21T154707_1_yxtlfh.png'
        }
        alt = 'question person' / >
        <
        /div> <
