...
function Unlock() {
    ...
    return ( <
        ...
        <
        img src = {
            'https://res.cloudinary.com/dapbrn8a9/image/upload/q_auto:low/v1711104809/Untitled_design_-_2024-03-20T182856_1_bvfuoa.png'
        }
        alt = 'unlock'
        className = 'w-[80%]' / >
        <
        ...
        <
        div className = 'flex justify-center items-center text-[#F76F32] font-Gilroy font-bold text-center space-y-2 text-xl sm:text-3xl md:text-2xl lg:text-4xl ' > Unlock Your Influencer Potential! < /div> <
        div className = 'flex flex-col justify-center items-center text-center font-Gilroy font-medium text-[#404040] lg:text-2xl xl:text-2xl' > Get a Quick Snapshot of Your Earning Potential. < /div> <
        /div> <
        /div>

        <
        div class = 'p-8 w-[90%] md:w-[80%] h-full flex flex-col justify-evenly items-start border-[1px] border-black shadow-[5px_5px_0_0_#C9C9C9] shadow-red  rounded-2xl bg-white' >

        <
        div className = 'text-black text-lg font-semibold' > I have < span className = 'text-[#F76F32] text-lg font-semibold' > {
            initialAnimationComplete ?
        ...
        <
        div className = "range__slider-line w-full h-[70px]"
        style = {
            {
                width: `${(progress1 - 500) / 9950}%`
            }
        } >
        < /div> <
        /div> <
        div className = "range__thumb w-[4%] md:w-[1.6%]"
        style = {
            {
                left: `${window.innerWidth < 768 ? (progress1 - 600)/10100:(progress1 - 500) / 10100}%`
            }
        } >
        <
        div className = "range__value" >
        <
        span className = "range__value-number font-Gilroy text-sm font-normal" > {
            formatProgress1(progress1)
        } < /span> <
        /div> <
        /div> <
        input type = "range"
        ...
        <
        div className = 'text-black text-lg font-semibold' > I typically share around < span className = 'text-[#F76F32] text-lg font-semibold' > {
            initialAnimationComplete ?
            `${progress2} Posts` :
                `100 Followers`
        } <
        ...
        style = {
            {
                left: `${window.innerWidth < 768? (progress2-3):(progress2-0.5)}%`
            }
        } >
        <
        div className = "range__value" >
        ...
        <
        div className = 'font-Gilroy font-normal text-2xl mb-[2rem]' >
        You have the potential to < span className = 'text-[#F76F32] font-Gilroy font-bold text-2xl' > earn < /span> an additional <span className='text-[#F76F32] font-Gilroy font-bold text-2xl'>₹{calculationFunc()}</span > !
        <
        div className = "font-Gilroy text-sm text-[#3D3D3D] pt-2" > * Based on estimates that 1 % to 5 % of your followers make direct purchases from your store. < /div> <
        /div> <
        /div>
        ...
        <
        div className = 'font-Gilroy font-semibold text-3xl md:text-3xl lg:text-5xl text-centre' > Wait, we have < span className = 'text-[#F76F32]' > more to offer!! < /span></div >
        <
        div className = 'flex flex-col fustify-center md:flex-row overflow-x-hidden' >
        <
        div className = 'flex flex-col md:flex-row w-[86%] justify-center items-center mx-auto pt-10'
        data - aos = "fade-right" >
        <
        ...
        <
        img src = 'https://res.cloudinary.com/dapbrn8a9/image/upload/v1712577019/Group_1171277259_f5u0ne.png'
        alt = 'unlocked'
        className = 'w-[96%]' / >
        <
        ...
        <
        img src = 'https://res.cloudinary.com/dapbrn8a9/image/upload/v1712577022/Group_1171277254_gh3zdx.png'
        alt = 'unlocked'
        className = 'w-[96%]' / >
        <
        ...
        /div> <
        /div> <
        div class = 'flex flex-col md:flex-row w-[86%] justify-center items-center mx-auto gap-5 pt-10'
        data - aos = "fade-left" >
        <
        ...
        div class = 'flex flex-col items-center justify-center' >
        <
        img src = 'https://res.cloudinary.com/dapbrn8a9/image/upload/v1712577017/Group_1171277253_siji10.png'
        alt = 'unlocked'
        className = 'pl-3' / >
        <
        ...
        div class = 'flex flex-col items-center justify-center' >
        <
        img src = 'https://res.cloudinary.com/dapbrn8a9/image/upload/v1712577019/Group_1171277260_1_ds7z16.png'
        alt = 'unlocked' / >
        <
